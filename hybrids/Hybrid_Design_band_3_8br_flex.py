...
fn.agregaArreglo(oProject,"variables", "[0, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.64,2.7,1.3]mm")  
...
fn.agregaVariable(oProject,"L","13.0mm")
###############################################################################
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[9]/2",
		"ZPosition:="		, "-variables[5]/2-variables[1]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[9]",
		"ZSize:="		, "variables[1]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[9]/2",
		"ZPosition:="		, "variables[5]/2 + variables[6]+ variables[1]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[9]",
		"ZSize:="		, "variables[2]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[9]/2",
		"ZPosition:="		, "-variables[5]/2-variables[6]-variables[1]-variables[2]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[9]",
		"ZSize:="		, "variables[2]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[9]/2",
		"ZPosition:="		, "variables[5]/2 + variables[6]+ variables[7]+variables[1]+variables[2]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[9]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[9]/2",
		"ZPosition:="		, "-variables[5]/2-variables[6]-variables[7]-variables[1]-variables[2]-variables[3]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[9]",
		"ZSize:="		, "variables[3]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[9]/2",
		"ZPosition:="		, "variables[5]/2 + variables[6]+ variables[7]+ variables[8]+variables[1]+variables[2]+ variables[3]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[9]",
		"ZSize:="		, "variables[4]"
	], 
...
oEditor.CreateBox(
	[
		...
		"XPosition:="		, "-variables[10]/2",
		"YPosition:="		, "-variables[9]/2",
		"ZPosition:="		, "-variables[5]/2-variables[6]-variables[7]-variables[8]-variables[1]-variables[2]-variables[3]-variables[4]",
		"XSize:="		, "variables[10]",
		"YSize:="		, "variables[9]",
		"ZSize:="		, "variables[4]"
	], 
...
oProject.SaveAs("D:\\HFSS\\Save_data\\"+"Band3_Hybrid_8br_flex"+'.aedt', True)
